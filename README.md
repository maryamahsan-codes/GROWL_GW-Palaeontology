...
The `onboarding\_growl` folder contains my personalized versions of the onboarding notebooks. These notebooks include my solutions to the exercises, explanatory comments, and, where applicable, further exploratory analysis.



The notebooks containing my work are identified by the `\_maryam` suffix:



The original notebooks and other GROWL materials were developed by Floor Broekgaarden and the GROWL contributors. My contributions are limited to the solutions, comments, modifications, and exploratory analysis in the personalized notebooks.
